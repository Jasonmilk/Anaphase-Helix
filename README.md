...
[![Tests](https://img.shields.io/badge/tests-124%2F124%20passed-green)](#)
...
- ✅ **Full Test Coverage** — 124/124 passing (lib + 10 integration suites incl. security gate + Tuck gate + D'-4 live) +
...
Run the full suite (**124/124 passing**):
```bash
cargo test
```
