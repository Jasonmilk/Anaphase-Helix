...
| [lark-base-record-upload-attachment.md](lark-base-record-upload-attachment.md) | `+record-upload-attachment` | 上传文件到附件字段并更新记录 |
...
- 文件写入附件字段时，必须使用 `+record-upload-attachment`。
