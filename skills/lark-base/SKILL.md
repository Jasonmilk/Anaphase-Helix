...
本技能的多个命令需要 **用户 open_id**（`ou_xxx`）作为入参。当上下文中没有现成的 ID，需要通过搜索来获取时：
...
- [lark-base-form.md](references/lark-base-form.md) — form 命令索引（`+form-list / +form-get / +form-create / +form-update / +form-delete`）
- [lark-base-form-questions.md](references/lark-base-form-questions.md) — form questions 命令索引（`+form-questions-list / +form-questions-create / +form-questions-update / +form-questions-delete`）
...
| [`form commands`](references/lark-base-form.md) | `+form-list / +form-get / +form-create / +form-update / +form-delete` |
| [`form questions commands`](references/lark-base-form-questions.md) | `+form-questions-list / +form-questions-create / +form-questions-update / +form-questions-delete` |
