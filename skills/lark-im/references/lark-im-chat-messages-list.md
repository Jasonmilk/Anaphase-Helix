...
| Resource Type | Marker in Content |
|---------|-------------|
| Image | `[Image: img_xxx]` |
| File | `<file key="file_xxx" .../>` |
| Audio | `<audio key="file_xxx" .../>` |
| Video | `<video key="file_xxx" .../>` |
...
| `P2P chat not found for this user` | `--user-id` was used but no P2P chat exists with that user | Confirm the target direct-message relationship exists |
